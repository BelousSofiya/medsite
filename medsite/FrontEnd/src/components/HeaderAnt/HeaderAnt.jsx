    ...
    <Layout>
      <Header className="header">
        ...
        >
          ...
          <Menu.Item key="2">Protocols</Menu.Item>
          <Menu.Item key="3">Organizations</Menu.Item>
        </Menu>
      </Header>
      <Layout>
        <Sider width={200} style={{ background: '#fff' }}>
          ...
          >
            <SubMenu key="sub1" title={<span>Your profile</span>}>
              <Menu.Item key="1">Patient</Menu.Item>
              <Menu.Item key="2">Doctor</Menu.Item>
              <Menu.Item key="3">Owner</Menu.Item>
            </SubMenu>
